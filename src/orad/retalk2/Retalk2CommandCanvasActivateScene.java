 ...
 * @author org.ovrn
 */
class Retalk2CommandCanvasActivateScene extends Retalk2Command{
    private final static byte[] ACTIVATEPREFIX = ("\u0008\u0051\u0000\u0000\u0000"
            ...
            +"\n\u0014\u0000\u0000\u0000^Method3Modification"
            +"\n\u0007\u0000\u0000\u0000/Scenes"
            +"\n\u0014\u0000\u0000\u0000Activate scene index").getBytes(Retalk2Settings.ENCODINGNAME);
    private final String sceneName;
    private final int slot;
    
    
    Retalk2CommandCanvasActivateScene(Retalk2ConnectionController connection, String name, int slot){ 
        super(connection);
        sceneName = name;
        this.slot = slot;
    }
    ...
    byte[] getData() throws UnsupportedOperationException {
        ...
        encoder.addOradInt(7);
        encoder.addOradInt(slot);
        encoder.addOradInt(13);
